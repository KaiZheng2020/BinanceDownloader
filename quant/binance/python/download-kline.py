            ...
            for year in years:
                for month in months:
                    ...
                    if current_date >= start_date and current_date <= end_date:
                        ...
                        save_path = get_save_path(trading_type, "klines", symbol, interval)
...
if __name__ == "__main__":
    ...
    if args.dates:
        ...
        download_monthly_klines(args.type, symbols, num_symbols, args.intervals, args.years, args.months, args.startDate,
                                args.endDate, args.folder, args.checksum)
    download_daily_klines(args.type, symbols, num_symbols, args.intervals, dates, args.startDate, args.endDate, args.folder,
                          args.checksum)
